...
item1_price = float(input("Price of " + item1_name + " (Rs): "))

item2_name = input("Item 2 name: ")
item2_price = float(input("Price of " + item2_name + " (Rs): "))

item3_name = input("Item 3 name: ")
item3_price = float(input("Price of " + item3_name + " (Rs): "))
...
print("GST (" + str(gst_percent) + "%): + Rs." + str(round(gst_amount, 2)))
...
print("Total to pay: Rs." + str(round(final_bill, 2)))
