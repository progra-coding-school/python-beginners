...
result = 10 / 2
print("  10 / 2 =", result, " (type: " + type(result).__name__ + ")")
...
result1 = 5 % 10
result2 = 3 % 100
print("  5 % 10 =", result1, " (not 5, but... actually yes, 5 itself!)")
print("  3 % 100 =", result2)
...
print("  age=15, has_id=False")
print("  age >= 13 AND has_id =", result_and)
print("  age >= 13 OR has_id =", result_or)
...
x = 3
print("  3 ** 2 =", 3 ** 2, " (3 to the power 2 = 3 x 3 = 9)")
print("  3 * 2  =", 3 * 2, "  (3 multiplied by 2 = 6)")
print("  WRONG! ** means 'raised to the power', not 'times 2'.")
print("  3 ** 3 =", 3 ** 3, ", but 3 * 3 =", 3 * 3)
print()
