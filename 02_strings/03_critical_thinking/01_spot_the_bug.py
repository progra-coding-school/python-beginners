...
print()
print("For each buggy program below:")
print("  1. Read the code carefully")
print("  2. Find the bug")
print("  3. Press ENTER to see the bug explained")
print("  4. See the fixed version")
...
BUG: Comparison is case-sensitive.
   "Progra2026" and "progra2026" are not equal.
...
input("Found the bug? Press ENTER for explanation: ")
print("""
BUG: "Python " (with space) is not equal to "Python"
