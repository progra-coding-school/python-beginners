...
print()
print("Welcome to Progra Mad Libs!")
print("You'll give me some words — I'll make a funny story.")
print("DON'T read the story first. Just answer the questions!")
...
print()
print("Want to create another story? Run the program again!")
