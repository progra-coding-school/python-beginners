# Assumption Breaker
# Common wrong beliefs about sets. Run each block to BUST or CONFIRM the assumption.
# Breaking false assumptions prevents bugs before they happen.

# --- Assumption 1: "Sets keep items in the order I add them" ---
# Many beginners assume .add() preserves insertion order — it does NOT
...
# {} was used for dicts before sets were added to Python — {} is always a dict
...
# Only immutable (hashable) types — strings, numbers, tuples — can go in a set
print("Assumption 3: Sets can store any type:")
try:
    mixed = {1, "hello", [1, 2]}    # list is unhashable → TypeError
...
# list() and sorted() both work on any iterable — including sets
...
# Difference is NOT symmetric — order matters, just like subtraction in maths
print("Assumption 5: Difference is symmetric:")
a = {1, 2, 3, 4}
b = {3, 4, 5, 6}
print("a - b:", a - b)   # {1, 2} — in a but not b
print("b - a:", b - a)   # {5, 6} — in b but not a
...
# frozenset supports all the same operators — it just cannot be mutated after creation
