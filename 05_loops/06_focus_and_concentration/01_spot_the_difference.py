...
print("         range(5) starts at 0. range(1,5) starts at 1.")
score += 1
print()
...
print("Answer: A counts down by 1:", a_out.strip())
print("         B counts down by 2:", b_out.strip())
score += 1
print()
...
print("Answer: A gives " + str(total_a) + " (correct sum). B gives " + str(total_b) + " (starts 1 too high).")
...
print("Answer: A prints " + str(2+2) + " (2+2). B prints " + str(2*2) + " (2×2).")
