...
for i in range(100_000):
    try:
        ...
        pass
print("  Summed 0–99999 =", total, "(try block ran 100,000 times, very fast)\n")
...
try:
    ...
    print("  SyntaxError caught via exec():", e)
...
for val in ["5", "abc"]:
    try:
        ...
        print("  Failed: '" + val + "' is not an int")
    finally:
        print("  [finally] always executed for '" + val + "'")
print()
...
for val in ["hello", None, "0"]:
    try:
        result = 10 / int(val)
        print("  Result for", repr(val) + ":", round(result, 2))
    except (ValueError, TypeError, ZeroDivisionError) as e:
        print("  Caught for", repr(val) + ":", type(e).__name__ + ":", e)
print()
